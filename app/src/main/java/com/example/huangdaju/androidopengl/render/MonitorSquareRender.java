...
public class MonitorSquareRender implements GLSurfaceView.Renderer {
    ...
    public MonitorSquareRender(Context mContext) {
    ...
    public void onSurfaceCreated(GL10 gl10, EGLConfig eglConfig) {
        ...
        vertexShaderCode = ShaderUtils.getVertexShader(mContext, "triangle_vertex_full_shader");
        fragmentShaderCode = ShaderUtils.getFragShader(mContext, "triangle_frag_full_shader");

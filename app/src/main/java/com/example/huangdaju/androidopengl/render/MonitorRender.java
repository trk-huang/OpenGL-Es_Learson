...
public class MonitorRender implements GLSurfaceView.Renderer {
    ...
    public MonitorRender(Context mContext) {
    ...
    public void onSurfaceCreated(GL10 gl10, EGLConfig eglConfig) {
        ...
        vertexShaderCode = ShaderUtils.getVertexShader(mContext, "triangle_vertex_shader");
